...
INSERT INTO dorms (id, name, description, location, image_url) VALUES
  (
    ...
    'https://via.placeholder.com/400x300?text=John+Jay+Hall'
  ),
  (
    ...
    'Morningside Heights Campus',
    'https://via.placeholder.com/400x300?text=Carman+Hall'
  ),
  (
    ...
    'Morningside Heights Campus',
    'https://via.placeholder.com/400x300?text=Wallach+Hall'
  ),
  (
    ...
    'Morningside Heights Campus',
    'https://via.placeholder.com/400x300?text=Hartley+Hall'
  ),
  (
    ...
    'Morningside Heights Campus',
    'https://via.placeholder.com/400x300?text=McBain+Hall'
  ),
  (
    ...
    'Morningside Heights Campus',
    'https://via.placeholder.com/400x300?text=East+Campus'
  ),
  (
    ...
    'Morningside Heights Campus',
    'https://via.placeholder.com/400x300?text=Wien+Hall'
  ),
  (
    ...
    'Morningside Heights Campus',
    'https://via.placeholder.com/400x300?text=Schapiro+Hall'
  ),
  (
    ...
    'Morningside Heights Campus',
    'https://via.placeholder.com/400x300?text=Broadway+Hall'
  ),
  (
    ...
    'https://via.placeholder.com/400x300?text=Cathedral+Gardens'
  );
